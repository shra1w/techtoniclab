            ...
            <div className="relative  w-full h-full shrink-0 p-0 md:p-6 flex items-center  gap-5 max-w-screen mx-auto pt-[6%]  ">
                ...
                <div className=" w-full border  md:w-[50%]  h-[90vh] md:h-[75vh]  absolute md:backdrop-blur-none backdrop-blur-md  md:relative flex justify-center flex-col items-center overflow-hidden">
                   ...
                   <div className=" relative flex flex-col pl-[5%]  md:pl-[13%] text-[3.7rem] leading-[3.4rem] tracking-tight font-semibold text-zinc-100 md:text-zinc-950">
                        <h1 className=" text-[1.4rem] md:text-[1.6rem] mb-2 w-auto flex flex-wrap leading-4 gap-2 uppercase text-teal-600 font-semibold  text-start"><span>Accelerate</span> <span>Your</span> <span>Career</span> <span>Growth</span></h1>
                    <h1 className="text-transparent bg-clip-text  bg-gradient-to-r md:from-teal-700 from-zinc-100 via-zinc-900 to-sky-500 md:text-zinc-900">Empowering</h1>
                    <h1 className="text-transparent bg-clip-text  bg-gradient-to-r md:from-teal-700 from-zinc-100 via-zinc-900 to-sky-500 md:text-zinc-900">Future IT Professionals</h1>
                    <p className=" text-[1.3rem]  text-zinc-200  md:text-zinc-500 tracking-wide  leading-6 mt-4  w-[90%] md:w-[70%] text-wrap">Unlock your potential with expert guidance tailored to help you land your dream job.
                    Start your journey toward a brighter future today</p>
                    <Link href="#contact"><div className="w-56 mt-5  group  h-10 rounded-full bg-zinc-200 md:bg-teal-600 hover:bg-zinc-900 hover:bg-opacity-100 duration-300  md:bg-opacity-35 text-[1.1rem] flex items-center px-1 ">
            ...
            <div className=" w-[full md:h-[90vh] h-[100vh]  relative flex justify-center items-center">
                <div className=" w-[150%] h-full absolute rotate-[5deg] bg-zinc-100 px-4 flex md:flex-row flex-col-reverse items-center  ">
                    <div className="  w-[100%] md:w-[55%]   md:border-none border-t border-zinc-900 h-full  flex justify-between items-start relative ">
                        <div className=" absolute w-1 top-0 left-[26%] md:left-[50%] -rotate-[5deg] h-[5rem] md:h-[8rem] border border-teal-600 bg-teal-600 rounde-b-md ">
                            <div className=" absolute -bottom-16 left-6 flex flex-col">
                                ...
                                <h1 className=" w-[40%] text-semibold leading-4 md:leading-5 text-[1rem]  md:text-[1.2rem]">Personalized Career Coaching</h1>
                            </div>
                            <div className="absolute -bottom-[1.9rem] -left-4 text-[2rem]  text-teal-600"><GrRadialSelected/></div>
                        </div>
                        <div className=" absolute w-1 top-0 left-[46%] md:left-[65%] -rotate-[5deg] h-[14rem] md:h-[16rem] border border-teal-600 bg-teal-600 rounde-b-md">
                            <div className=" absolute -bottom-16 left-6 flex flex-col">
                                <Image src={skill} alt="leader" className=" w-12 md:w-16"/>
                                ...
                                <h1 className=" w-[40%] text-semibold leading-5 text-[1rem] md:text-[1.2rem]">Skill Enhancement Resources</h1>
                            </div>
                            <div className="absolute -bottom-[1.9rem] -left-4 text-[2rem]  text-teal-600"><GrRadialSelected/></div>

                        </div>
                        <div className=" absolute w-1 top-0 left-[70%] md:left-[80%] -rotate-[5deg] h-[22rem] md:h-[30rem] border border-teal-600 bg-teal-600 rounde-b-md">

                            <div className=" absolute -bottom-16 left-6 flex flex-col">
                                <Image src={skill} alt="leader" className= "w-12 md:w-16"/>
                                <div className=" w-10 h-10 rounded-full bg-teal-600 text-[1.8rem]  grid place-items-center  absolute  -left-20 text-zinc-100">3</div>
                                <h1 className=" w-[40%] text-semibold leading-5 text-[1rem] md:text-[1.2rem]">Job & Internship Matching</h1>
                            </div>
                            <div className="absolute -bottom-[1.9rem] -left-4 text-[2rem]  text-teal-600"><GrRadialSelected/></div>
                    ...
                    <div className=" w-[100%] md:w-[50%] h-full  flex flex-col justify-center items-start pl-[20%] md:pl-[5%] -rotate-[5deg] md:mb-20">
                        ...
                        <p className=" text-[1.2rem] w-[70%] md:w-[50%]">"Simple, Guided, and Effective—
