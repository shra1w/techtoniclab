...
export default function BoxesDesign(){
    return(
        ...
        <div className={` ${outfit.className} absolute    left-[50%] top-[10%] grid md:mt-0 mt-10 grid-rows-3 grid-cols-3 gap-1`}>
            ...
            <div className=" w-[14vw] h-[12vh] hidden md:flex justify-center items-center top-6 rounded-lg bg-zinc-200 bg-opacity-10 backdrop-blur-sm absolute p-2">
...
<div className=" w-[14vw] h-[12vh] md:hidden flex justify-center items-center  top-[20%] rounded-lgbg-zinc-200 bg-opacity-10  absolute p-2">
<div className=" w-full h-full  rounded-md"></div>
<div className=" layout w-14 h-14 md:w-10 md:h-10 shrink-0 absolute text-zinc-100 text-[1.6rem] md:text-[1.4rem] rounded-full grid place-items-center bg-zinc-950 ">
    <TbLayoutDashboardFilled />
</div>
<div className=" layout-textphone origin-left w-[15rem] h-[5rem]  text-[1.1rem] absolute left-[100%] md:left-[60%] bottom-[70%] md:bottom-[65%] rounded-md bg-zinc-100 shadow-xl shadow-orange-200 p-2 flex items-center text-sky-700  leading-5 px-3 text-center">
From learning to earning, we've got you covered.
</div>
<div className=" w-[15rem] layout-textphone origin-left h-[5rem] text-[1.1rem] absolute left-[100%] md:right-[60%] top-[70%] md:top-[65%] rounded-md bg-zinc-100 shadow-xl flex items-center shadow-sky-200 p-2 text-sky-700  leading-5 px-3 text-center">
    Empowering students with skills and opportunities.
